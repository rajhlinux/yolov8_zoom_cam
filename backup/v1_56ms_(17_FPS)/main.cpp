...
void ClsTest()
{
    ...
    ReadCocoYaml(yoloDetector);
    DL_INIT_PARAM params{ model_path, YOLO_CLS_HALF, {640, 640} }; // <-------------- Make sure to set correct image input parameters such as "YOLO_CLS" for FP16 or "YOLO_CLS_HALF" for FP32 or "640 x 640". 
    yoloDetector->CreateSession(params);
